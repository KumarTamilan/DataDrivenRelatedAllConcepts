package org.dataPassToWebpageFromXmlFile;
...
public class DataPassFromXmlFile {

	@Parameters({"username1","password1","firstName1","lastName1","day1","month1","year1","mobileNumber1","newPassword1"})
	@Test
