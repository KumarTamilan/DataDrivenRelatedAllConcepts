...
public class PassTheDataFromOneDataMethod {

	@Test(dataProvider="TestDatass")
	...
	@DataProvider(name="TestDatass")
	public Object[][] qaData() {
		Object[][] data = {{"Kumaran","Karuppannan","Amutha","Hema","15","8","1993","7564364564","HarshRith"}};
		return data;
	}
}
