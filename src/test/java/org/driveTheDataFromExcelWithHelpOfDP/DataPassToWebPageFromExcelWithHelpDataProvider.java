package org.driveTheDataFromExcelWithHelpOfDP;
...
public class DataPassToWebPageFromExcelWithHelpDataProvider {

	@Test(dataProvider="TestData")
	public static void main(String username1,String password1,String firstName1,String lastName1,
			String day1,String month1,String year1,String mobileNumber1,String newPassword1) {
	...
	public String[][] qaData() {
		PropertyReaderClass reader = new PropertyReaderClass(".\\Excel\\FBData.xlsx","Sheet3");
